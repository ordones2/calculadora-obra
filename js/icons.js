// Ícones da biblioteca Lucide (https://lucide.dev) inline como SVG — sem CDN nem
// build. Traço fino (stroke-width <= 2, padrão 1.75) e stroke="currentColor",
// então herdam a cor do contexto. Conteúdo (paths) é o oficial do Lucide (ISC).
...
const PATHS = {
  ...
  "door-open":
    '<path d="M13 4h3a2 2 0 0 1 2 2v14"/><path d="M2 20h3"/><path d="M13 20h9"/><path d="M10 12v.01"/><path d="M13 4.562v16.157a1 1 0 0 1-1.242.97L5 20V5.562a2 2 0 0 1 1.515-1.94l4-1A2 2 0 0 1 13 4.562Z"/>',
  home:
  ...
  wallet:
    '<path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3a1 1 0 0 1-1 1H5a2 2 0 0 1-2-2V6"/><path d="M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4"/>',
  "file-text":
...
/** Retorna o markup SVG do ícone Lucide pedido. */
export function icon(name, { size = 24, stroke = 1.75, cls = "" } = {}) {
  const inner = PATHS[name] || PATHS.sparkles;
  return `<svg class="icon ${cls}" xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${stroke}" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${inner}</svg>`;
}
